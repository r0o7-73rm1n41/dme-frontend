...
const translations = {
  en: {
    ...
    // Winners Page
    dailyMindEducation: "Daily Mind Education",
    quizResults: "Quiz Results",
    congratulationsWinners: "Congratulations To The Winners!",
    resultsNotPublished: "Results Not Published Yet",
    resultsAvailable: "Results for {date} will be available 30 minutes after the quiz ends.",
    autoRefreshing: "Auto-refreshing every 30 seconds...",
    tryDifferentDate: "Try selecting a different date or wait for the results.",
    congratulationsAll: "Congratulations to all winners!",
    joinTomorrowQuiz: "Join tomorrow's quiz for your chance to win!",
    ...
    quizRemindersDesc: "Get notified before daily quiz starts",
    paymentAlerts: "Payment Alerts",
    paymentAlertsDesc: "Notifications for payment status",
    winnerAnnouncements: "Winner Announcements",
    winnerAnnouncementsDesc: "Get notified when quiz results are announced",
    account: "Account",
    profileInformation: "Profile Information",
    profileInformationDesc: "Update your profile details",
    ...
    developer: "Developer:",
    developerName: "fcityonline Team",
    ...
    email: "Email: dailymind.edu@gmail.com",
  ...
  hi: {
    ...
    email: "ईमेल: dailymind.edu@gmail.com",
