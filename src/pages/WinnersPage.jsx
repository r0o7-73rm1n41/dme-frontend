      ...
      <div key={"dup_" + i} className="winnerr">{name}</div>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '40px' }}>
            ...
            <p>Results for {formatDate(quizDate)} will be available 30 minutes after the quiz ends.</p>
            {selectedDate === new Date().toISOString().split('T')[0] && (
              <p style={{ color: '#666', fontSize: '14px' }}>Auto-refreshing every 30 seconds...</p>
            )}
            <p>Try selecting a different date or wait for the results.</p>
          </div>
        ) : (
