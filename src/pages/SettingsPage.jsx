    ...
    <>
      ...
      <main className="settings-container home-container">
        <div className="settings-section">
          ...
          <div className="setting-item">
            <div className="setting-info">
              <span className="setting-label">{t('quizReminders')}</span>
              <span className="setting-desc">{t('quizRemindersDesc')}</span>
            </div>
          ...
          <div className="setting-item">
            <div className="setting-info">
              <span className="setting-label">{t('paymentAlerts')}</span>
              <span className="setting-desc">{t('paymentAlertsDesc')}</span>
            </div>
            <label className="toggle-switch">
              <input
                type="checkbox"
          ...
          <div className="setting-item">
            <div className="setting-info">
              <span className="setting-label">{t('winnerAnnouncements')}</span>
              <span className="setting-desc">{t('winnerAnnouncementsDesc')}</span>
            </div>
            <label className="toggle-switch">
              <input
                type="checkbox"
        ...
        <div className="settings-section">
          ...
          <div className="setting-item">
            <div className="setting-info">
              <span className="setting-label">{t('profileInformation')}</span>
              <span className="setting-desc">{t('profileInformationDesc')}</span>
            </div>
            <button 
        ...
        <div className="settings-section">
          ...
          <div className="setting-item">
            <div className="setting-info">
              ...
              <span className="setting-desc">{t('darkModeDesc')}</span>
            {/* <DarkModeToggle /> */}
            </div>
          </div>
          ...
          <div className="about-info">
            ...
            <div className="about-item">
              ...
              <span className="about-value">{t('developerName')}</span>
            </div>
          </div>
        </div>
        ...
        <div className="settings-section danger-zone">
          ...
          <div className="setting-item">
            <div className="setting-info">
              ...
              <span className="setting-desc">{t('logoutDesc')}</span>
            </div>
            <button 
          ...
          <div className="setting-item">
            <div className="setting-info">
              <span className="setting-label">{t('deleteAccount')}</span>
              <span className="setting-desc">{t('deleteAccountDesc')}</span>
            </div>
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              <button className="danger-btn2" onClick={handleDeleteAccount}>{t('deleteAccount')}</button>
            </div>
          </div>
        </div>
        </main>
